...
EVIDENCE_ITEMS = [
    ...
    EvidenceItem(
        ...
        next_gap="Run forwarding echo after AWS credentials open; if it passes, implement the NAT-rebinding proxy variant as passive/path-change continuity evidence.",
    ),
    EvidenceItem(
