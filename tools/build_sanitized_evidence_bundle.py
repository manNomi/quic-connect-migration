...
EVIDENCE_ITEMS = [
    ...
    EvidenceItem(
        ...
        do_not_claim="Chrome/Safari/Android browser handover, managed-CDN/LB continuity, or custom ngtcp2 HTTP/3 workload continuity beyond the referenced local tests.",
        next_gap="Build a focused ngtcp2/nghttp3 echo or HTTP/3 migration harness only if reviewers require a second C-library runtime positive control.",
    ),
    EvidenceItem(
        id="ngtcp2-runtime-trial-packet",
        chapter="1",
        category="implementation-runtime-readiness",
        implementation="ngtcp2",
        ...
        claim_strength="runtime_readiness_blocked",
        supports="A fail-closed ngtcp2 osslclient/osslserver HTTP/3 migration runner and trial packet now separate example dependency readiness from runtime PASS claims.",
        do_not_claim="ngtcp2 example HTTP/3 workload continuity, browser handover, or managed deployment success until the runner records validation=ok with path-validation frame evidence.",
        next_gap="Install or provide libev through pkg-config, rerun with REQUIRE_READY=1, and promote only if client_exit=0 plus PATH_CHALLENGE/PATH_RESPONSE evidence appear.",
    ),
    EvidenceItem(
