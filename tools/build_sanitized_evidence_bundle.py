...
EVIDENCE_ITEMS = [
    ...
    EvidenceItem(
        ...
        next_gap="Implement and run dedicated live AWS NLB+s2n target A/B forwarding runner.",
    ),
    EvidenceItem(
        ...
        local_artifact_id="s2n-nlb-live-readiness-local-20260630",
        claim_strength="readiness_blocked",
        supports="Current live AWS+s2n experiment is fail-closed because AWS identity is invalid and dedicated runner is pending.",
        do_not_claim="Live AWS resource creation or live s2n NLB migration evidence.",
        next_gap="Refresh AWS credentials and add dedicated s2n live NLB runner.",
    ),
    EvidenceItem(
