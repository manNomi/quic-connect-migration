...
TRACKS = [
    ...
    Track(
        ...
        current_state="local_controls_pass_user_origin_not_h3_ready",
        can_run_now=False,
        blocker="The user-provided public HTTPS origin is reachable but currently has no `Alt-Svc: h3`; a controlled H3 origin and active desktop path-change gate are still needed.",
