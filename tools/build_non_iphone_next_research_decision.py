...
TRACKS = [
    Track(
        ...
        next_command_or_action="Refresh AWS credentials, run `harness/scripts/run-aws-s2n-nlb-live-data-plane.sh`, then run it again with `PATH_CHANGE_MODE=rebinding_proxy PAYLOAD_CHUNKS=8 CHUNK_DELAY_MS=250` if forwarding echo passes.",
