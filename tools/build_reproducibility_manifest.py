...
def build_manifest(include_ci: bool = False) -> dict[str, Any]:
    ...
    evidence_paths_20260630 = {
        ...
        "msquic_rebind_pathvalidation_runner": "harness/scripts/run-msquic-rebind-pathvalidation-demo.sh",
        ...
        "ngtcp2_example_migration_runner": "harness/scripts/run-ngtcp2-example-migration-demo.sh",
        ...
        "quinn_rebind_runtime_runner": "harness/scripts/run-quinn-rebind-runtime-demo.sh",
