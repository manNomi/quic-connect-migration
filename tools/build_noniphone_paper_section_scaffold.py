...
SECTIONS = [
    ...
    SectionRow(
        ...
        evidence_ids=("noniphone-public-workload-trial-packet", "controlled-public-origin-workload-deploy-packet", "controlled-public-chrome-bridge-synthesis", "controlled-public-chrome-artifact-classifier-contract"),
        wording_sections=("method",),
