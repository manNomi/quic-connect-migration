...
TRIAL_ID="${TRIAL_ID:-${CONTROLLED_PUBLIC_NETWORK_CHANGE_RUN_ID:-controlled-public-chrome-downlink-noheartbeat-network-change-001}}"
ARTIFACT_DIR="${ARTIFACT_DIR:-$REPRO_DIR/${CONTROLLED_PUBLIC_NETWORK_CHANGE_ARTIFACT_DIR:-artifacts/$TRIAL_ID}}"
SERVER_ARTIFACT_DIR="${CONTROLLED_PUBLIC_NETWORK_CHANGE_SERVER_ARTIFACT_DIR:-${CONTROLLED_PUBLIC_NETWORK_CHANGE_ARTIFACT_DIR:-artifacts/$TRIAL_ID}}"
