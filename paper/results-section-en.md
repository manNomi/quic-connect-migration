...
The combined workload transition-zone table shows that downlink is mixed at 5000 ms and 5500 ms before repeated failure at 6000 ms, while upload becomes mixed at 4750 ms and repeatedly fails from 4900 ms. The continuity metric should therefore be reported as workload-specific transition zones, not as one universal outage-duration threshold.
