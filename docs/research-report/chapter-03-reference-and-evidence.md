...
quic-go만 강하게 검수했다는 약점을 줄이기 위해 2026-06-30에 9개 구현체를 현재 HEAD 기준으로 다시 실행했고, quicly는 partial build/unit evidence를 추가로 확보했다.
...
| implementation fresh rerun summary | [docs/results/implementation-rerun-results-20260630.md](../results/implementation-rerun-results-20260630.md) | 2026-06-30 현재 HEAD 기준 quiche/picoquic/s2n-quic/MsQuic/ngtcp2/aioquic/Quinn/Neqo/XQUIC 재실행과 quicly partial 요약 |
...
| quic-go 외 구현체도 fresh rerun을 확보했는가? | PASS | quiche, picoquic, s2n-quic, MsQuic, ngtcp2, aioquic, Quinn, Neqo, XQUIC NAT rebinding demo |
...
| 외부 구현체 링크가 있는가? | PASS | 10개 구현체 official/source/docs link 포함 |
