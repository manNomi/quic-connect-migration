...
| remaining external cleanup gap | `72.7 MiB` |
...
| 2 | `todo-now` | storage | Free enough disk before running heavy browser/qlog captures. | Current artifact cleanup candidates are insufficient for the target free-space threshold; remaining external cleanup gap is 72.7 MiB. |
