...
| experiment trials | `56` |
| experiment status counts | `{'PASS': 25, 'PASS_NEGATIVE_CONTROL': 25, 'PASS_FEASIBILITY': 6}` |
...
| Android ready | `no` |
| AWS identity OK | `no` |
| disk available GiB | `24.17` |
| local artifact roots total | `13.8 GiB` |
