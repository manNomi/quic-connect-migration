...
| --- | --- | --- | --- | --- | --- |
| `disk-free-space` | `now` | `ready` | Free local disk until at least 5.0 GiB is available before heavy NetLog/qlog captures. | `python3 tools/report_artifact_storage.py --output docs/results/artifact-storage-report-20260624.md` | `current_free=11.2 GiB; target_met=True` |
