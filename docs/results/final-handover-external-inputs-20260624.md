...
| --- | --- | --- | --- | --- | --- |
| `disk-free-space` | `now` | `ready` | Free local disk until at least 7.0 GiB is available before heavy NetLog/qlog captures. | `python3 tools/plan_artifact_cleanup.py --target-free-gib 7 --candidate-policy review-unreferenced --output docs/results/artifact-cleanup-dry-run-20260624.md` | `current_free=9.3 GiB; target_met=True` |
