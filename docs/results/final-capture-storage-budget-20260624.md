...
| --- | ---: | ---: | --- | ---: | --- |
| `next-planned-execution` | 1 | 2.0 | `no` | 1.08 | Enough space to attempt only the next selected capture if storage_ready=yes. |
| `all-remaining-final-executions` | 10 | 20.0 | `no` | 19.08 | Enough space for the full remaining final browser handover queue if storage_ready=yes. |
