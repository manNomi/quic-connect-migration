...
| usable GiB before floor | `9.16` |
| max executions before floor | `4` |
| current local artifact roots | `22.4 GiB` |
...
| `all-remaining-final-executions` | 10 | 20.0 | `no` | 10.84 | Enough space for the full remaining final browser handover queue if storage_ready=yes. |
