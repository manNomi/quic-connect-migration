...
| usable GiB before floor | `2.39` |
| max executions before floor | `1` |
...
| `all-remaining-final-executions` | 10 | 20.0 | `no` | 17.61 | Enough space for the full remaining final browser handover queue if storage_ready=yes. |
