...
| LiteSpeed LSQUIC | full CTest 79/79 and selected primitive tests | PASS | server-stack unit evidence |
...
| LiteSpeed LSQUIC | fresh full CTest로 승격 | 서버 스택 단위 테스트는 통과했지만 app-level OpenLiteSpeed/LSQUIC migration demo는 후속 필요 |
