...
| NetLog target path validation counts | `{'true': 3}` |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| upload-r1 | PASS | `nat_rebinding_path_validation_without_observed_tuple_change` | 1 | 1 | 1 | 262144 | 1/1 | 1/1 | 87/159 | true |
| upload-r2 | PASS | `nat_rebinding_path_validation_without_observed_tuple_change` | 1 | 1 | 1 | 262144 | 1/1 | 1/1 | 89/161 | true |
| upload-r3 | PASS | `nat_rebinding_path_validation_without_observed_tuple_change` | 1 | 1 | 1 | 262144 | 1/1 | 1/1 | 90/161 | true |
