...
| --- | --- | --- | --- | --- | --- | --- |
| `implementation-policy` | implementation | CM primitives exist, but support is implementation- and policy-specific | 53 (PASS=20;PASS_FEASIBILITY=5;PASS_NEGATIVE_CONTROL=28) | 19 (A=16;B=3) | source-backed explanation with repo evidence | Runtime browser and mobile-client migration trials with policy artifacts. |
...
| `middlebox-manageability` | middlebox | Middleboxes and firewalls lose 5-tuple semantics | 24 (PASS=13;PASS_FEASIBILITY=3;PASS_NEGATIVE_CONTROL=8) | 8 (A=6;B=2) | cautious explanatory support | Optional Mininet or firewall reproduction only if the paper claims middlebox behavior directly. |
...
| `observability-gap` | methods | Browser and network artifacts are individually ambiguous | 47 (PASS=18;PASS_FEASIBILITY=4;PASS_NEGATIVE_CONTROL=25) | 12 (A=11;B=1) | source-backed explanation with repo evidence | Complete final browser handover rows with all required artifacts. |
