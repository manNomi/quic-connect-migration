...
상세 결과는 `docs/results/iphone-usb-boundary-and-active-short-20260626.md`에 기록했다.

## 다음 실행 추천

가장 가까운 다음 실행은 `boundary8000-32kb trigger timing sweep`이다. no-change baseline은 성공했고 active 2초 trigger는 3/3 미완료였으므로, trigger 시점이 결과를 바꾸는지 확인하는 것이 좋다.

권장 matrix:

| duration_ms | bytes | chunks | repetition | 목적 |
| ---: | ---: | ---: | ---: | --- |
| 8000 | 32768 | 8 | 3 | trigger timing 4초 조건 |
| 8000 | 32768 | 8 | 3 | trigger timing 6초 조건 |
| 8000 | 32768 | 8 | 3 | heartbeat/retry application recovery 분리 |
