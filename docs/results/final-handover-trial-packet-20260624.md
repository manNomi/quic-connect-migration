...
| role | path |
| --- | --- |
| server result | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/results/server.json` |
| server qlog directory | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/qlog` |
| public origin readiness | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/results/public-origin-readiness.json` |
| classifier summary | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/results/controlled-public-h3-baseline-summary.json` |
| Chrome bootstrap NetLog | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/chrome/bootstrap-netlog.json` |
| Chrome second NetLog | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/chrome/second-netlog.json` |
| Chrome public H3 summary | `repro/quic-go-min-repro/artifacts/controlled-public-chrome-h3-baseline-001/results/chrome-public-h3-summary.json` |
