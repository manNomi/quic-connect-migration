...
| claim class counts | `{'strong_cross_implementation_positive': 5, 'server_or_app_runtime_positive': 5, 'focused_or_partial_positive': 2, 'source_or_readiness_only': 2, 'negative_control': 1, 'managed_or_deployment_pending': 2}` |
| evidence status counts | `{'fresh_app_demo_20260630': 1, 'fresh_focused_e2e_full_gate_20260701': 1, 'fresh_negative_control_20260630': 1, 'fresh_rebind_demo_20260630': 1, 'fresh_rerun_20260630': 5, 'fresh_runtime_20260630': 1, 'fresh_runtime_20260701': 3, 'partial_deferred': 1, 'source_edge_boundary_audit_20260701': 1, 'source_inspected': 1, 'source_policy_audit_20260701': 1}` |
...
| 6 | MsQuic | `server_or_app_runtime_positive` | `fresh_runtime_20260701` | `L4_selected_runtime_tests` | `policy_constrained` | `yes` | `yes` | Selected v4/v6 rebind/path-validation runtime-test row is positive; QUIC-aware load balancing and application payload continuity remain separate gates. | Use as selected v4/v6 NAT rebind/path-validation runtime-test positive control; live QUIC-aware LB and app payload continuity remain follow-up |
| 7 | Quinn | `server_or_app_runtime_positive` | `fresh_runtime_20260701` | `L4_runtime_rebind` | `partial` | `yes` | `yes` | Endpoint-rebind runtime row is positive; HTTP/3 application, browser handover, and managed deployment remain separate claims. | Use as Rust endpoint-rebind runtime positive control; HTTP/3/browser/deployment rows remain follow-up |
