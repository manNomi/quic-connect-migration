...
| 6 | MsQuic | `strong_cross_implementation_positive` | `fresh_rerun_20260630` | `L4_L5_caveat` | `needs_api_check` | `yes` | `yes` | NAT rebind/path validation tests are positive; QUIC-aware load balancing remains a deployment assumption to verify. | Use as production-relevant NAT rebinding/path-validation evidence; still verify QUIC-aware LB deployment assumptions |
