...
| `baseline` | `PUBLIC_ORIGIN_URL` | client | private lab URL | https URL whose host equals PUBLIC_ORIGIN_HOST | `no` | add PUBLIC_ORIGIN_URL to the local env file |
...
| `active` | `PUBLIC_ORIGIN_NETWORK_CHANGE_URL` | client | private lab URL | long-running https workload URL whose host equals PUBLIC_ORIGIN_HOST | `no` | add PUBLIC_ORIGIN_NETWORK_CHANGE_URL to the local env file |
