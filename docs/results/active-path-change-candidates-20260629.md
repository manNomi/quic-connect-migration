...
| `macos_wifi_to_iphone_usb_latent_failover` | `yes` | ready: Wi-Fi is active and iPhone USB is present but latent/inactive | `networksetup -setairportpower <wifi-device> off` | `networksetup -setairportpower <wifi-device> on` |
